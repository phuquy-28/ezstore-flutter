                      ...
                      child: ListView(
                        ...
                        children: [
                            ...
                            children: [
                              ...
                              MultiImagePicker(
                                ...
                                onNetworkImagesRemoved: (remainingImages) {
                                  viewModel.updateOriginalProductImages(
                                      remainingImages);
                                },
                                onReplaceNetworkImage: (index, newImage) {
                                  viewModel.replaceProductImage(
                                      index, newImage);
                                },
                              ),
                          ...
                          ...viewModel.variants.asMap().entries.map((entry) {
                            ...
                            final widgetVariant =
                                add_product_model.ProductVariant(
                              color: variant.color,
                              sizeDetails: variant.sizeDetails
                                  .map((detail) =>
                                      add_product_model.VariantDetail(
                                          size: detail.size,
                                          quantity: detail.quantity,
                                          priceDifference:
                                              detail.priceDifference))
                                  .toList(),
                            ...
                            return ProductVariantItem(
                              ...
                              onVariantChanged: (updatedVariant) {
                                ...
                                for (final newDetail
                                  ...
                                  int? originalId;
                                  for (final origDetail
                                      in variant.sizeDetails) {
                              ...
                              detailErrors:
                                  viewModel.variantDetailErrors[index],
                            );
                          }).toList(),
