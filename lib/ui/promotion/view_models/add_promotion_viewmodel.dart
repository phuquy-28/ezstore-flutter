...
class AddPromotionViewModel extends ChangeNotifier {
  ...
  Future<bool> createPromotion() async {
    ...
    try {
      ...
      final result = await _promotionRepository.createPromotion(reqPromotion);
      ...
      if (result != null) {
        ...
        _errorMessage = 'Không thể tạo khuyến mãi mới';
        return false;
      }
    } catch (e) {
      _errorMessage = 'Lỗi: $e';
