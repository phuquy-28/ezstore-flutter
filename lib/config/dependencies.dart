...
List<SingleChildWidget> get providers {
  return [
    ...
    Provider(create: (context) => PromotionService(context.read<ApiService>())),
    Provider(create: (context) => ReviewService(context.read<ApiService>())),
